...
public class FriendsActivity extends AppCompatActivity {
    ...
    private void getLocation() {
        ...
        if (ActivityCompat.checkSelfPermission(FriendsActivity.this,Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(FriendsActivity.this,
